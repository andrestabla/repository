...
export default function WorkbooksV2Page() {
    return (
        <div className="min-h-screen bg-[#f4f7fb] text-[#0f172a] px-6 py-10 md:px-10 md:py-12">
            <div className="max-w-[1280px] mx-auto space-y-10">
                <section className="rounded-3xl border border-slate-200 bg-white p-8 md:p-10 shadow-[0_14px_36px_rgba(15,23,42,0.08)]">
                    <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold tracking-[0.18em] uppercase text-blue-700">
                        <Sparkles size={14} />
                        Workbooks v2
                    </div>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {WORKBOOKS_V2_CATALOG.map((workbook) => (
                        ...
                        >
                            ...
                            <h2 className="mt-5 text-2xl font-extrabold leading-tight text-slate-900">
                                {workbook.title}
                            </h2>
                            ...
                            <Link
                                ...
                                className="mt-7 inline-flex items-center gap-2 rounded-xl bg-slate-900 text-white px-4 py-2.5 text-sm font-bold hover:bg-slate-800 transition-colors"
                            >

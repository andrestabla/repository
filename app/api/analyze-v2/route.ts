...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        console.log(`[Analyze V2] Fetching content for ${driveId}...`)
        ...
        if (driveId) {
            ...
            if (mimeType.startsWith('video/') || mimeType.startsWith('audio/')) {
                console.log(`[Analyze V2] Detected Media: ${mimeType}. Starting Transcription Pipeline...`)
        ...
        if (url) {
            ...
            console.log(`[Analyze V2] Analyzing URL: ${targetUrl}`)
            try {
        ...
        console.log(`[Analyze V2] Sending ${text.length} chars to Gemini with context: ${type}...`)
        ...
        console.error('[Analyze V2 Error]', msg)

        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            {isLoading ? (
                ...
                <div className="grid gap-5">
                    ...
                    {releases.length === 0 && (
                        <div className="text-center py-20 bg-panel border-2 border-dashed border-border rounded-xl opacity-40">
                            No hay versiones creadas aún. Comienza creando la v1.0.
                        </div>
                    )}
                </div>
            )}

            <div className="mt-12 bg-accent/5 border border-accent/20 rounded-xl p-6">
                <h5 className="m-0 mb-3 text-[14px] font-bold text-accent">¿Qué significa Congelar?</h5>
                <ul className="text-[12px] text-text-muted space-y-2 list-disc pl-5">
                    <li>Se crea un **Snapshot inmutable** de los activos asociados.</li>
                    <li>Ningún Curador podrá modificar los contenidos de esta versión.</li>
                    <li>Garantiza que los entregables generados para clientes sean siempre consistentes.</li>
                    <li>Si se requiere un cambio, se debe generar un nuevo parche (ej: v1.1).</li>
                </ul>
            </div>
        </div>
    )
